...
class Receiver {
    ...
    public static function parseReceivers($data)
    {
        ...
        while(isset($data[sprintf(self::FORMAT_STRING, $i, "email")])) {
            $primary =  isset($data[sprintf(self::FORMAT_STRING, $i, "primary")]) ? $data[sprintf(self::FORMAT_STRING, $i, "primary")] : '';
    ...
    public static function addReceiversToOutput($items, &$output)
    {
        ...
        foreach ($items as $item) {
           ...
           $output[sprintf(self::FORMAT_STRING, $i, "primary")] = $item->isPrimary();
            $i++;
        }
    }
    ...
    {
        return "email: " . $this->email . " amount: " . $this->amount . " primary: " . $this->isPrimary;
    }
}
